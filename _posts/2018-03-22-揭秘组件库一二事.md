...
title: "揭秘组件库一二事"
date: 2018-03-22 
description: "从 0 到 1 搭建一个属于自己的组件库"
tag: 合格前端
---  
...
![api-1](https://user-gold-cdn.xitu.io/2018/3/17/162336a2a93d2cd6?w=3812&h=1968&f=png&s=461343 "PC 端预览图")

![api-2](https://user-gold-cdn.xitu.io/2018/3/17/162336a2a840dea4?w=918&h=1742&f=png&s=99459 "移动端预览图")
...
![hello](https://user-gold-cdn.xitu.io/2018/3/17/162336a2b146bd82?w=778&h=646&f=png&s=22035 "Hello")
...
![run-dev](https://user-gold-cdn.xitu.io/2018/3/17/162336a2a8178907?w=1248&h=428&f=png&s=65278 "npm run dev")
...
![build](https://user-gold-cdn.xitu.io/2018/3/17/162336a2ac6205cb?w=2746&h=720&f=png&s=204853 "npm run build:vui")

至此，有关本地服务以及两个打包文件便已改造完成，下面我们尝试将 `npm` 使用起来 ~

### 2、发布 npm 包

注意，如果你还没有属于自己的 `npm` 账号的话，请先自行到 `npm` 官网注册一个账号，[点击这里进入官网进行注册](https://www.npmjs.com/) ，注册步骤比较简单，这里我就不过多做描述了，如果有疑问，可以在讨论群问我
...
![use-npm](https://user-gold-cdn.xitu.io/2018/3/17/162336a2a8ad1108?w=778&h=646&f=png&s=22035 "use npm")
...
![bem](https://user-gold-cdn.xitu.io/2018/3/17/162336a2cdf83588?w=758&h=386&f=png&s=17326 "bem")
...
![build-vui-css](https://user-gold-cdn.xitu.io/2018/3/17/162336a2d6cba3f9?w=454&h=220&f=png&s=17790 "build vui-css")
...
![markdown](https://user-gold-cdn.xitu.io/2018/3/17/162336a2dd8bae9d?w=1288&h=1472&f=png&s=173567 "markdown")
...
![markdown](https://user-gold-cdn.xitu.io/2018/3/17/162336a2e14c7a57?w=2520&h=2078&f=png&s=278109 "markdown 高亮预览")
...
![api-7](https://user-gold-cdn.xitu.io/2018/3/17/162336a30102795a?w=2822&h=1646&f=png&s=258690 "页面预览")
...
![](https://user-gold-cdn.xitu.io/2018/3/17/162336a2e28947f2?w=796&h=1144&f=png&s=37439)

到这一步为止，我们“粗陋”的组件库架子便已经全部搭建完毕。

博文到这里也差不多要结束了，文章中所有的代码都已经托管到了 `github` 上，后续我还会写一篇文章，带着大家逐步完善我们组件库中的一些细节，让我们的组件库能够更加的完美。
...
![](https://user-gold-cdn.xitu.io/2018/3/17/162336a30140f075?w=480&h=853&f=jpeg&s=58872 "大佬们快到碗里来")